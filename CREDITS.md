...
| The Parade Armour of King Erik XIV of Sweden (armadura, modelo de los enemigos) | The Royal Armoury (Livrustkammaren) | [Sketchfab](https://sketchfab.com/3d-models/the-parade-armour-of-king-erik-xiv-of-sweden-bd189bba7d9e4924b12826a6d68200d9) | **CC-BY 4.0** — requiere atribución | `assets/models/sketchfab_cc/parade_armour_erik_xiv/` — usado en `scenes/enemies/enemy.tscn` y `scenes/enemies/ranged_enemy.tscn` |
